    ...
    <section id="contact" className="bg-white px-6 md:px-13 py-28 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="inline-flex items-center gap-3.5 px-13 py-5 border-[1.5px] border-[--color-blue] text-[--color-blue] text-xs font-bold tracking-[2.5px] uppercase no-underline rounded-sm transition-all hover:bg-[--color-blue] hover:text-white hover:-translate-y-[3px]"
        >
          Instagram
        </a>
      </div>
